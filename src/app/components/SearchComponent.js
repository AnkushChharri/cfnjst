                ...
                <div tabIndex={-1} className="mx-4 space-y-5 *:flex *:flex-col *:items-center *:text-center *:gap-y-2 pt-3">
                    ...
                    <div className="max-h-fit max-w-7xl mx-auto my-auto mt-2 h-auto">
                        <div className="text-justify capitalize font-semibold subpixel-antialiased text-sm ml-2 mr-3">
                            ...
                            <h1 className="pt-2 text-sm tracking-tight">1. Fancy Font: Add Elegance to Your Words</h1>
                            ...
                            <h1 className="pt-2 text-sm tracking-tighter">2. Bold Text: Make Your Message Stand Out</h1>
                            ...
                            <h1 className="pt-2 text-sm tracking-tighter">3. Italic Text: For Subtle Emphasis</h1>
                            ...
                            <h1 className="pt-2 text-sm -tracking-tighter">4. Fancy Text: Beyond Basic Formatting</h1>
                            ...
                            <h1 className="pt-2 text-sm tracking-tighter">5. Zalgo Text: Adding a Touch of Chaos to Your Digital Content</h1>

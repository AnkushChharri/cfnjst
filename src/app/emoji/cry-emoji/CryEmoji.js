...
const symbols = [
    // Cry emojis and related sad/tearful emojis
    '😢', '😭', '😿', '😥', '😓', '😰', '😪', '😹',
    '😔', '😞', '😟', '🙁', '☹️', '😣', '😖', '😫', '😩', '🥺',
    '😕', '😦', '😧', '😨', '😰', '😯', '😲', '😳', '🤯', '😬',
    '😰', '😱', '🥶', '😶‍🌫️', '😶', '😮‍💨', '💔', '💧', '🌊'
...
const CryEmojiSelector = () => {
    ...
    return (
        <div className="max-w-4xl m-auto p-4">
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-2 text-gray-700">Cry and Sad Emojis</h3>
...
export default CryEmojiSelector;
...
const EmojiComparison = () => {
    ...
    return (
        <div className="max-w-4xl m-auto p-4">
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-2 text-gray-700">Smile Emojis</h3>
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-2 text-gray-700">Smile Emoji Comparison Across Platforms</h3>

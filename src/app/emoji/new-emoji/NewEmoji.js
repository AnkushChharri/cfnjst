...
const platforms = [
    ...
    { name: 'Apple', className: 'font-[Apple Color Emoji]' },
    { name: 'Google', className: 'font-[Noto Color Emoji]' },
    { name: 'Microsoft', className: 'font-[Segoe UI Emoji]' },
];
...
const EmojiComparison = () => {
    ...
    return (
        <div className="max-w-4xl m-auto p-4">
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-2 text-gray-700">Popular Emojis</h3>
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-2 text-gray-700">Emoji Comparison Across Platforms</h3>

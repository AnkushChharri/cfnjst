...
const symbols = [
    '🤷', '🤷‍♂️', '🤷‍♀️',  // Basic shrug emojis
    '🤷🏻', '🤷🏻‍♂️', '🤷🏻‍♀️',  // Light skin tone
    '🤷🏼', '🤷🏼‍♂️', '🤷🏼‍♀️',  // Medium-light skin tone
    '🤷🏽', '🤷🏽‍♂️', '🤷🏽‍♀️',  // Medium skin tone
    '🤷🏾', '🤷🏾‍♂️', '🤷🏾‍♀️',  // Medium-dark skin tone
    '🤷🏿', '🤷🏿‍♂️', '🤷🏿‍♀️'   // Dark skin tone
];
...
const SymbolSelector = () => {
    ...
    return (
        <div className="max-w-4xl m-auto p-4">
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-2 text-gray-700">All Shrug Emojis</h3>
